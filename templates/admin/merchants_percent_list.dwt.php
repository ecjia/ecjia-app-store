	...
	<form method="post" action="{$search_action}" name="searchForm">
		<div class="btn-group f_l m_r5">
			...
			<ul class="dropdown-menu">
				<li><a class="button_remove" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url="{url path='seller/admin_percent/batch'}" data-msg="您确定要删除选中的佣金比例吗？" data-noSelectMsg="请先选中要删除的佣金比例！" data-name="id" href="javascript:;"><i class="fontello-icon-trash"></i>{t}删除佣金比例{/t}</a></li>
			</ul>
		</div>
	</form>
</div>
		...
		<div class="tab-content">
			<div class="row-fluid">
				<table class="table table-striped smpl_tbl dataTable table-hide-edit">
					<thead >
					    <tr data-sorthref='{url path="seller/admin_percent/init"}'>
					...
					<tbody>    
						...
						<tr>
					    	...
					    	<td class="cursor_pointer">
					      	...
					      	<td>
					      		<a class="data-pjax" href="{RC_Uri::url('seller/admin_percent/edit',"id={$percent.percent_id}")}" title="编辑"><i class="fontello-icon-edit"></i></a>
      							<a data-toggle="ajaxremove" class="ecjiafc-red" data-msg="{t}您确定要删除吗？{/t}" href="{RC_Uri::url('seller/admin_percent/remove',"id={$percent.percent_id}")}" title="删除"><i class="fontello-icon-trash"></i></a>
					      	</td>
					    </tr>
					    <!-- {foreachelse} -->
