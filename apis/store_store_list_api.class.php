			...
			if (!empty($result)) {
				...
				foreach($result as $k => $val){
					...
					$seller_list[] = array(
					        ...
					        'province' => $result[$k]['province'] ? RC_DB::table('regions')->where('region_id', $result[$k]['province'])->pluck('region_name') : '',
    					    'city' => $result[$k]['city'] ? RC_DB::table('regions')->where('region_id', $result[$k]['city'])->pluck('region_name') : '',
    					    'district' => $result[$k]['district'] ? RC_DB::table('regions')->where('region_id', $result[$k]['district'])->pluck('region_name') : '',
